		...
		<div class="col-12">
			<div class="card my-4">
				<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
					<div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 mb-2">
					...
					<div class="row">
						<div class="card col-4">
							<div class="card-header p-3 pt-2">
								...
								<div class="text-start pt-6">
									<p class="text-2xl text-bold mb-0">Total Pemasukan</p>
									<h4 class="mb-0">Rp.
						...
						<div class="card col-4">
							<div class="card-header p-3 pt-2">
								...
								<div class="text-start pt-6">
									<p class="text-2xl text-bold mb-0">Total Pengeluaran</p>
									<h4 class="mb-0">Rp.
										<!-- <?= number_format($pendapatan['pendapatan_sekarang']) ?> -->
									</h4>
								</div>
						...
						<div class="card col-4">
							<div class="card-header p-3 pt-2">
								...
								<div class="text-start pt-6">
									<p class="text-2xl text-bold mb-0">Saldo Akhir</p>
									<h4 class="mb-0">Rp.
										<!-- <?= number_format($pendapatan['pendapatan_sekarang']) ?> -->
									</h4>
								</div>
